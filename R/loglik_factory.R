...
llk.fn <- function(cfg, ab, tau, family) {
  ...
  result <- switch(method,
                   "CE"   = loglik_ce(ab = ab, tau=tau,c = arg2, od=od, ret_llk = ret_llk, df=df, family=family),
                   "CE_test"   = loglik_ce_test(ab = ab, tau=tau,c = arg2, od=od, ret_llk = ret_llk, df=df, family=family),
                   "GHK"  = loglik_ghk(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                       ret_llk = ret_llk, df=df, family=family),
                   "GHK_test"  = loglik_ghk_test(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                       ret_llk = ret_llk, df=df, family=family),
                   "GHK_mvt"  = loglik_ghk_mvt(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                               ret_llk = ret_llk, df=df, family=family),
                   "TMET" = loglik_tmet(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                        ret_llk = ret_llk, df=df, family=family),
                   "TMET_optim" = loglik_tmet_optim(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                        ret_llk = ret_llk, df=df, family=family),
                   "VMET" = loglik_vmet(ab = ab, tau=tau, M = arg2, od=od, QMC=QMC,
                                        ret_llk = ret_llk, df=df, family=family),
