...
#' \itemize{
#'   \item \code{mean}, \code{median}, \code{mode}, \code{variance}
#'   \item \code{CRPS} and \code{LOGS} (if \code{y_obs} provided)
#'   \item \code{p_y}: predictive pmf over \code{0:y_max}
#'   \item \code{lower}, \code{upper}: 95\% predictive interval
#' }
#'
